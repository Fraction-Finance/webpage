...
const Footer = memo(() => {
  ...
  const socialLinks = [
    { name: 'X', icon: X, href: 'https://x.com/Fractioncl' },
    { name: 'LinkedIn', icon: Linkedin, href: 'https://www.linkedin.com/company/fractioncl/' },
    { name: 'Instagram', icon: Instagram, href: 'https://www.instagram.com/fraction.finance/' },
  ...
  return (
    <footer className="bg-transparent text-gray-700 py-12">
