    ...
    const Ecosystem = () => {
      ...
      useEffect(() => {
        const fetchPartners = async () => {
          ...
          const {
            data,
            error
          } = await supabase.from('ecosystem_partners').select('*').order('category', {
            ascending: true
          }).order('created_at', {
            ascending: true
          });
      ...
      const benefits = [{
        ...
        description: 'Acceso a una red mundial de inversores institucionales y gestores de activos',
        icon: Globe
      }, {
        title: 'Pozo de Liquidez',
        description: 'Profunda liquidez a través de un mercado integrado y centros de negociación',
        icon: Droplet
      }, {
        title: 'Red de Cumplimiento',
        description: 'Cumplimiento automatizado en múltiples jurisdicciones y regulaciones',
        icon: Scale
      }, {
        title: 'Pila Tecnológica',
        description: 'La mejor infraestructura de su clase de socios líderes en blockchain y fintech',
        icon: Wrench
      }];
      return <>
              <Helmet>
              ...
              <div className="pt-16">
                ...
                duration: 0.8
                  ...
                  return <motion.div key={categoryIndex} initial={{
                    opacity: 0,
                    y: 20
                  }} whileInView={{
                    opacity: 1,
                    ...
                    delay: categoryIndex * 0.1
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                                {partnerList.map((partner, partnerIndex) => <motion.div key={partner.id} initial={{
                        opacity: 0,
                        scale: 0.9
                      }} whileInView={{
                        opacity: 1,
                        ...
                        duration: 0.4,
                        delay: partnerIndex * 0.05
                      }} className="bg-white/70 p-4 rounded-xl hover:bg-gray-100 transition-all duration-300 cursor-pointer group flex flex-col items-center text-center" onClick={handlePartnerClick}>
                ...
                <section className="py-20">
                  ...
                  duration: 0.8
                        ...
                        <div className="space-y-4 mb-8">
                          {['Acceso a una red global de inversores', 'Oportunidades de reparto de ingresos', 'Soporte de integración técnica', 'Co-marketing y desarrollo de negocios'].map((item, index) => <div key={index} className="flex items-center">
