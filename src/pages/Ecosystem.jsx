...
const Ecosystem = () => {
  ...
  const benefits = [{
    ...
    description: 'Acceso a una red de inversores institucionales y gestores de activos',
    icon: Globe
  }, {
            ...
            <section className="py-20">
              ...
              duration: 0.8
                    ...
                    <div className="space-y-4 mb-8">
                      {['Acceso a una red de inversores', 'Oportunidades de reparto de ingresos', 'Soporte de integración técnica', 'Co-marketing y desarrollo de negocios'].map((item, index) => <div key={index} className="flex items-center">
