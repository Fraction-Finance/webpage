import React, { useState, useEffect, lazy, Suspense } from 'react';
    ...
    const Ecosystem = () => {
      ...
      const benefits = [
        { title: 'Alcance Global', description: 'Acceso a una red mundial de inversores institucionales y gestores de activos', icon: Globe },
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                            {partnerList.map((partner, partnerIndex) => (
                              <motion.div
                                ...
                                className="bg-white/70 p-4 rounded-xl hover:bg-gray-100 transition-all duration-300 cursor-pointer group flex flex-col items-center text-center"
                                onClick={handlePartnerClick}
                              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  >
                    ...
                    <div className="space-y-4 mb-8">
                      {[
                        'Acceso a una red global de inversores',
                        'Oportunidades de reparto de ingresos',
                        'Soporte de integración técnica',
                        'Co-marketing y desarrollo de negocios'
                      ].map((item, index) => (
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      >
                        Postula para ser Socio
                      </Button>
                      <Button 
                        onClick={handlePartnerClick}
                        variant="outline" 
                        size="lg"
                        className="glass-effect border-gray-200 text-gray-800 hover:bg-gray-100 px-8 py-4 rounded-full font-semibold text-lg"
                      >
                        Guía de Asociación
                      </Button>
                    </div>
