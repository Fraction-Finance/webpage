...
const CookiePolicy = () => {
    ...
    return (
        <>
            <Helmet>
                <title>{policy?.title || 'Política de Cookies'} | Fraction Finance</title>
                <meta name="description" content={`Lee nuestra ${policy?.title || 'Política de Cookies'}.`} />
            </Helmet>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    {loading ? (
                        ...
                        <div className="text-center">
                            ...
                            <p className="mt-4 text-lg text-gray-600">No se pudo cargar el contenido de la política de cookies.</p>
                        </div>
                    )}
                </div>
            </div>
