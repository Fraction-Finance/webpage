...
const TermsOfService = () => {
    ...
    return (
        <>
            <Helmet>
                <title>{policy?.title || 'Términos de Servicio'} | Fraction Finance</title>
                <meta name="description" content={`Lee nuestros ${policy?.title || 'Términos de Servicio'}.`} />
            </Helmet>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    {loading ? (
                        ...
                        <div className="text-center">
                            ...
                            <p className="mt-4 text-lg text-gray-600">No se pudo cargar el contenido de los términos de servicio.</p>
                        </div>
                    )}
                </div>
            </div>
