  ...
  return <>
      ...
      <div className="container mx-auto px-4 py-24 sm:py-32">
        <header className="mb-8">
          ...
          <p className="mt-2 text-lg text-muted-foreground">Administra tu información personal, de inversión y seguridad.</p>
        </header>
        <div className="flex flex-col md:flex-row gap-8">
          <aside className="w-full md:w-1/4 lg:w-1/5">
            <nav className="flex flex-col space-y-2">
              ...
              isActive
            }) => `flex items-center px-4 py-3 text-sm font-medium rounded-md transition-colors ${isActive ? 'bg-primary text-primary-foreground' : 'hover:bg-accent hover:text-accent-foreground'}`}>
