          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter mt-4">
                ...
                <br />
                <span className="text-foreground">Desbloquea Liquidez.</span>
              </h1>
              <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">“Simplificamos tu acceso en la inversión de activos.”</p>
            </motion.div>
          </div>
        </section>
