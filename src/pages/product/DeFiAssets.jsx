...
const DeFiAssets = () => {
  const features = [
    {
      icon: Zap,
      title: 'Tokenización de Yield',
      description: 'Convierte tus rendimientos futuros en tokens negociables para liquidez instantánea.'
    },
    {
      icon: DollarSign,
      title: 'Acceso a LSTs y LP Tokens',
      description: 'Invierte en Liquid Staking Tokens (LSTs) y Liquidity Provider (LP) tokens con facilidad.'
    },
    {
      icon: Shield,
      title: 'Derivados DeFi',
      description: 'Explora oportunidades en derivados descentralizados para estrategias de cobertura y apalancamiento.'
    },
    {
      icon: TrendingUp,
      title: 'Estrategias de Earn',
      description: 'Participa en diversas estrategias de "Earn" para maximizar tus retornos en el ecosistema DeFi.'
    }
  ];
