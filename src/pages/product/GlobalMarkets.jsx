...
const GlobalMarkets = () => {
  const features = [
    { icon: Globe, title: 'Acceso Unificado', description: 'Conéctate a una red global de bolsas y centros de liquidez desde una única plataforma.' },
    { icon: TrendingUp, title: 'Liquidez Profunda', description: 'Accede a fondos de liquidez institucionales para una ejecución de órdenes eficiente y con bajo deslizamiento.' },
    { icon: Landmark, title: 'Liquidación Transfronteriza', description: 'Liquida operaciones en múltiples jurisdicciones de forma instantánea y cumpliendo con la normativa.' },
    { icon: ShieldCheck, title: 'Cumplimiento Regulatorio', description: 'Navega por los marcos regulatorios globales con nuestras herramientas de cumplimiento integradas.' },
    { icon: Shuffle, title: 'Interoperabilidad de Activos', description: 'Opera activos tokenizados de diferentes blockchains y estándares sin problemas.' },
    { icon: Clock, title: 'Operaciones 24/7', description: 'El mercado nunca duerme. Opera activos digitales en cualquier momento y lugar.' }
  ];
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                      {features.map((feature, index) => (
                        <motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: index * 0.1 }} className="glass-effect p-8 rounded-2xl hover:bg-gray-100 transition-all duration-300 group">
