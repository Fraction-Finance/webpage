...
const About = () => {
  ...
  const values = [
    { icon: Users, title: 'Democratizar el Acceso', description: 'Rompemos barreras para que los mercados de capitales sean accesibles para todos, en todas partes.' },
    { icon: Target, title: 'Impulsar la Innovación', description: 'Somos pioneros, aprovechando la tecnología de vanguardia para redefinir los servicios financieros.' },
    { icon: Rocket, title: 'Potenciar el Crecimiento', description: 'Proporcionamos las herramientas e infraestructura para que las empresas y los inversores prosperen.' },
    { icon: Globe, title: 'Fomentar la Transparencia', description: 'Creemos en el poder de los mercados abiertos y transparentes, construidos sobre la confianza y la integridad.' }
  ];
        ...
        <section className="py-20 glass-effect">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-2 gap-12">
                    <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="flex flex-col items-center text-center p-8 rounded-2xl bg-white/70 shadow-lg">
                        <div className="p-4 rounded-full bg-primary/10 mb-4">
                            <Lightbulb className="h-10 w-10 text-primary" />
                        </div>
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Nuestra Misión</h2>
                        <p className="text-lg text-gray-700 max-w-md">
                            Revolucionar la forma de invertir en activos financieros y reales, haciendo que la tokenización sea simple, segura y accesible para todos.
                        </p>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="flex flex-col items-center text-center p-8 rounded-2xl bg-white/70 shadow-lg">
                        <div className="p-4 rounded-full bg-primary/10 mb-4">
                            <TrendingUp className="h-10 w-10 text-primary" />
                        </div>
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Nuestra Visión</h2>
                        <p className="text-lg text-gray-700 max-w-md">
                            Impulsar la adopción global de la tokenización de activos del mundo real, liderando con confianza, transparencia y excelencia.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                {values.map((value, index) => (
                  <motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: index * 0.1 }} className="glass-effect p-8 rounded-2xl">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-center">
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-4xl">
